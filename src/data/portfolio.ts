...
export const about = {
  paragraphs: [
    ...
    "Certified EC-Council CSA (Certified SOC Analyst), CEH (Certified Ethical Hacker), CCSE (Certified Cloud Security Engineer), and CTIA (Certified Threat Intelligence Analyst).",
  ],
};
